...
figure
subplot(2,1,1)
plot(Cell_Temperature_max_vct,'DisplayName','Test temperature') % from experiment
hold on 
plot(Sese_maxCellTemperature_degC_fd,'DisplayName','Simulation temperature') % from simulation 
legend show
subplot(2,1,2)
plot(Cell_Temperature_min_vct,'DisplayName','Test temperature')
hold on
plot(Sese_minCellTemperature_degC_fd,'DisplayName','Simulation temperature')
legend show
% figure
