...
SimResults.Sese_packPower_kW_DCH= SimResults.Sese_packPower_kW_fd(idxDCH);
SimResults.Sese_packPower_kW_CHA= SimResults.Sese_packPower_kW_fd(idxCHA);
...
if isempty(SimResults.StopReason)
    SimResults.StopReason  ="Finished"; 

end
%% Summurize the results
SimResults.packPower_rms_kW             = rms(SimResults.Sese_packPower_kW_fd);
SimResults.packPower_avgAbsolute_kW             = mean(abs(SimResults.Sese_packPower_kW_fd));
...
if ~isempty(cutTime) % if record the period of thermal steady state 
resultSummaryPre = table(SimResults.StopReason,...
                        InputPar.CoolTIn, ...
                        ...
                        SimResults.packPower_avgAbsolute_kW,...
  ...
  resultSummaryPre.Properties.VariableNames= {'StopReason','CoolTempInlet_degC', ...
